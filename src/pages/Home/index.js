...
export default function HomePage() {
    ...
    const [isHoveredCard, setIsHoveredCard] = useState({ id: null, hover: false })
    const [isHoveredMember, setIsHoveredMember] = useState({ id: null, hover: false })
        ...
        <div className="w-full">
            ...
            <div className="bg-[#02121d]">
                <div className="xl:container xl:px-20 md:px-12 px-4 mx-auto h-full w-full lg:py-32 md:py-20 py-10 flex lg:flex-row flex-col items-start space-y-6 lg:space-y-0">
                    <div className="lg:w-1/3 w-full text-white font-body lg:pr-10 space-y-4">
                        <h3 className="text-[#28dbd1] md:text-2xl text-lg font-semibold">Trending</h3>
                        <h2 className="md:text-4xl text-2xl font-bold">Most Popular IGO Projects</h2>
                        <p className="font-medium text-white/80 text-sm md:text-base">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cum, quod?</p>
                        <div className="flex items-center space-x-4 pt-6">
                            <div onClick={() => setPrevSlide(true)} className="border border-[#0d3340] rounded w-11 h-11 cursor-pointer hover:bg-[#28dbd1] text-[#28dbd1] hover:text-[#0a1f2f] flex items-center justify-center bg-[#0a1f2f] -skew-x-6">
                                <BiLeftArrowAlt size={20} />
                            </div>
                            <div onClick={() => setNextSlide(true)} className="border border-[#0d3340] rounded w-11 h-11 cursor-pointer hover:bg-[#28dbd1] text-[#28dbd1] hover:text-[#0a1f2f] flex items-center justify-center bg-[#0a1f2f] -skew-x-6">
            ...
            <div className="bg-[#0a1f2f]">
                <div className="xl:container xl:px-20 md:px-12 px-4 mx-auto h-full w-full md:py-32 py-10 font-body flex flex-col items-center space-y-4">
                    <p className="text-[#28dbd1] font-semibold md:text-2xl text-lg">Getting Start</p>
                    <h1 className="text-white font-bold md:text-5xl text-2xl text-center">Simple as 1,2,3</h1>
                    <div className="flex flex-col md:flex-row justify-between items-center md:pt-16 pt-10 space-y-6 md:space-y-0">
                        <div className="md:w-1/4">
                            <StepCard id="1" toggle={toggleHoverCard} isHover={isHoveredCard} step="1" title="Submit KYC" img={stepImg1} desc="Lorem ipsum dolor sit amet consectetur adipiscing elit odio massa ege." />
                        </div>
                        <div className="md:w-1/4">
                            <StepCard id="2" toggle={toggleHoverCard} isHover={isHoveredCard} step="1" title="Submit KYC" img={stepImg2} desc="Lorem ipsum dolor sit amet consectetur adipiscing elit odio massa ege." />
                        </div>
                        <div className="md:w-1/4">
                            <StepCard id="3" toggle={toggleHoverCard} isHover={isHoveredCard} step="1" title="Submit KYC" img={stepImg3} desc="Lorem ipsum dolor sit amet consectetur adipiscing elit odio massa ege." />
                        </div>
                    </div>
                    <div className="pt-10">
            ...
            <div className="bg-[#02121d]">
                <div className="xl:container xl:px-20 md:px-12 px-4 mx-auto h-full w-full md:py-20 py-10 font-body flex flex-col items-center space-y-4">
                    <p className="text-[#28dbd1] font-semibold md:text-2xl text-lg">Explore</p>
                    <h1 className="text-white font-bold md:text-5xl text-2xl">Our Roadmap</h1>
                    <div className="hidden md:flex pt-10 w-full justify-between space-x-8">
                        <div ref={elemRef} className={`w-1/2 flex flex-col space-y-[13rem] mt-[13rem]`}>
                            <RoadmapCard title="Website Creation" step="02" 
                            ...
                            />
                            <RoadmapCard title="Website Creation" step="04" 
                                desc="Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, accusant ium! Dolores maxime 
                                    numquam animi saepe sapiente tempora, veritatis velit delectus debitis provident dolore 
                                    alias reiciendis cupiditate facere aliquid iusto inventore!" 
                            />
                        </div>
                        <div className={`p-1 h-[${cardHeight * 5}rem] bg-[#0a1f2f] rounded`}>
                            <div className={`bg-[#28dbd1] w-3 h-[30rem] rounded`}></div>
                        </div>
                        <div className="w-1/2 flex flex-col space-y-[13rem]">
                            <RoadmapCard title="Website Creation" step="01" 
                                desc="Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, accusant ium! Dolores maxime 
                                    numquam animi saepe sapiente tempora, veritatis velit delectus debitis provident dolore 
                                    alias reiciendis cupiditate facere aliquid iusto inventore!" 
                            />
                            <RoadmapCard title="Website Creation" step="03" 
                                desc="Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, accusant ium! Dolores maxime 
                                    numquam animi saepe sapiente tempora, veritatis velit delectus debitis provident dolore 
                                    alias reiciendis cupiditate facere aliquid iusto inventore!" 
                            />
                            <RoadmapCard title="Website Creation" step="05" 
                                desc="Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, accusant ium! Dolores maxime 
                                    numquam animi saepe sapiente tempora, veritatis velit delectus debitis provident dolore 
                                    alias reiciendis cupiditate facere aliquid iusto inventore!" 
                            />
            ...
            <div className="bg-[#0a1f2f]">
                <div className="xl:container xl:px-20 md:px-12 px-4 mx-auto h-full w-full md:py-32 py-10 font-body flex flex-col items-center space-y-4">
                    <p className="text-[#28dbd1] font-semibold md:text-2xl text-lg">Benefits</p>
                    <h1 className="text-white font-bold md:text-5xl text-2xl text-center">What We Offer</h1>
                    <div className="flex flex-col md:flex-row flex-wrap lg:flex-nowrap justify-between items-center md:pt-16 pt-10 lg:space-x-6 space-y-6 lg:space-y-0">
                        <div className="lg:w-1/4 md:w-1/2 px-4 lg:px-0">
                            <OfferCard title="Cross Chain" img={offerImg1} 
                                desc="Lorem ipsum dolor, sit amet consec tetur adipisicing elit. 
                                Provident eius eaque aspernatur amet " 
                            />
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 px-4 lg:px-0">
                            <OfferCard title="Stack Pad" img={offerImg2} 
                                desc="Lorem ipsum dolor, sit amet consec tetur adipisicing elit. 
                                Provident eius eaque aspernatur amet " 
                            />
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 px-4 lg:px-0">
                            <OfferCard title="Multi Layer" img={offerImg3} 
                                desc="Lorem ipsum dolor, sit amet consec tetur adipisicing elit. 
                                Provident eius eaque aspernatur amet " 
                            />
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 px-4 lg:px-0">
                            <OfferCard title="Elite Projects" img={offerImg4} 
                                desc="Lorem ipsum dolor, sit amet consec tetur adipisicing elit. 
                                Provident eius eaque aspernatur amet " 
                            />
                        </div>
